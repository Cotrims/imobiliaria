    ...
    public SecurityFilterChain securityFilterChain(
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        // páginas públicas
                        .requestMatchers("/", "/index", "/error", "/login", "/login/**", "/acesso-negado").permitAll()
                        ...
                        .requestMatchers("/imoveis", "/imoveis/listar").permitAll()
                        ...
                        .requestMatchers("/propostas/**").hasAnyRole("ADMIN", "IMOBILIARIA", "CLIENTE")
                        .requestMatchers("/imoveis/**").hasAnyRole("ADMIN", "IMOBILIARIA")

                        // cliente
                        .requestMatchers("/propostas/minhas", "/propostas/nova/**", "/propostas/salvar")
                        .hasRole("CLIENTE")

                        // imobiliária
                        .requestMatchers("/propostas/analisar/**", "/imoveis/meus").hasRole("IMOBILIARIA")
