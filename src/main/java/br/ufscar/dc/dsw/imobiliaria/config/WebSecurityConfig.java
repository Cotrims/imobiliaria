...
import br.ufscar.dc.dsw.imobiliaria.security.UsuarioDetailsService;
        ...
        public SecurityFilterChain securityFilterChain(
                ...
                http
                                ...
                                .authorizeHttpRequests(auth -> auth
                                                ...
                                                .requestMatchers(
                                                                "/imoveis/cadastrar", "/imoveis/salvar",
                                                                "/imoveis/editar",
                                                                "/imoveis/editar/**", "/imoveis/excluir/**",
                                                                "/imoveis/meus")
                                                .hasRole("IMOBILIARIA")

                                                // Listagem administrativa interna de imóveis. O catálogo público fica
                                                // liberado acima.
                                                ...
                                                .requestMatchers(
                                                                "/propostas/cadastrar", "/propostas/salvar",
                                                                "/propostas/minhas",
                                                                "/propostas/editar", "/propostas/editar/**",
                                                                "/propostas/excluir/**")
                                                .hasRole("CLIENTE")

                                                // AA1: imobiliária avalia propostas dos próprios imóveis.
                                                .requestMatchers("/propostas/imobiliaria", "/propostas/avaliar/**",
                                                                "/propostas/decidir")
                                                .hasRole("IMOBILIARIA")
